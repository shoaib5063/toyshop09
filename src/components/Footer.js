        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center mb-4">
              ...
              <span className="text-gray-900 font-bold text-xl">ToyVerse</span>
            </div>
            <p className="text-gray-600 mb-4 max-w-md">
              Your universe of fun and imagination. Discover amazing toys that bring joy to children and families worldwide.
            </p>
          </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="text-center md:text-right">
              <p className="text-gray-600 text-sm">
                © 2024 ToyVerse. All rights reserved.
              </p>
            </div>
          </div>
        </div>
